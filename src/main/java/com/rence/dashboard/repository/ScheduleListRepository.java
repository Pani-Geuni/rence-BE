...
public interface ScheduleListRepository extends JpaRepository<ScheduleListViewEntity, Object> {
	...
	public List<ScheduleListViewEntity> backoffice_schedule_list(String backoffice_no, String reserve_stime, String reserve_etime);
	...
	public List<ScheduleListViewEntity> backoffice_schedule_list_All(String backoffice_no);
