...
public interface BackOfficeRepository extends JpaRepository<BackOfficeEntity, Object> {
	...
	// 이메일 중복 체크
	@Query(nativeQuery = true, value="SELECT * from backofficeinfo where backoffice_email=?1 and backoffice_state !='X'")
	public BackOfficeEntity backoffice_email_check(String backoffice_email);
	...
	public BackOfficeEntity select_backoffice_by_id_email(String backoffice_id, String backoffice_email);
	...
	public BackOfficeEntity findByBackoffice_email(String backoffice_id); 
	...
	public BackOfficeEntity backoffice_login_info(String username);
	...
	public BackOfficeEntity selectOne_backoffice_detail_m(String backoffice_no);
