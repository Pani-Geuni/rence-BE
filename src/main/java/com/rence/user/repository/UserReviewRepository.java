...
public interface UserReviewRepository extends JpaRepository<UserReviewEntity, Object>  {
	...
	List<UserReviewEntity> select_all_review_paging(String user_no, Integer start_row, Integer end_row);
//	
//	//마이페이지 - 리뷰리스트
