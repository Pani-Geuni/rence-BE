...
//		log.info("go_my_page()...");
//		
//		UserMypageVO umvo = service.user_mypage_select(udto, request, response);
//		
...
//
//		int result = service.user_pw_updateOK(udto);
//
//		if (result == 1) {
...
//		Map<String, String> map = new HashMap<String, String>();
//
//		int result = service.check_now_pw(udto);
//
//		if (result == 1) {
...
//	public String user_img_updateOK(Model model, UserDto udto, HttpServletRequest request, HttpServletResponse response,
...
//		response.addCookie(cookie2);
//
//		int result = service.user_img_updateOK(udto);
//
...
//		Map<String, String> map = new HashMap<String, String>();
//
//		int result = service.user_secedeOK(udto);
//		log.info("result: {}", udto);
//		if (result == 1) {
//			session.invalidate();
...
//
//		// 총 마일리지 부분
//		UserMileageVO umvo = service.totalMileage_selectOne(udto);
//		log.info("umvo: {}", umvo);
//
//		// 마일리지 콤마단위로 변환
//		DecimalFormat dc = new DecimalFormat("###,###,###,###,###");
